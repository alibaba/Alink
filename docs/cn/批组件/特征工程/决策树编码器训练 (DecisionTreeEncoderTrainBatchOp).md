# 决策树编码器训练 (DecisionTreeEncoderTrainBatchOp)
Java 类名：com.alibaba.alink.operator.batch.feature.DecisionTreeEncoderTrainBatchOp

Python 类名：DecisionTreeEncoderTrainBatchOp


## 功能介绍
使用决策树分类模型，将输入数据编码为特征。
