# 决策树回归编码器训练 (DecisionTreeRegEncoderTrainBatchOp)
Java 类名：com.alibaba.alink.operator.batch.feature.DecisionTreeRegEncoderTrainBatchOp

Python 类名：DecisionTreeRegEncoderTrainBatchOp


## 功能介绍
使用决策树回归模型，将输入数据编码为特征。
