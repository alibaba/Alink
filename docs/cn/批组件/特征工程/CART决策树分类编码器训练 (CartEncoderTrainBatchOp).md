# CART决策树分类编码器训练 (CartEncoderTrainBatchOp)
Java 类名：com.alibaba.alink.operator.batch.feature.CartEncoderTrainBatchOp

Python 类名：CartEncoderTrainBatchOp


## 功能介绍
使用CART分类模型，将输入数据编码为特征。
