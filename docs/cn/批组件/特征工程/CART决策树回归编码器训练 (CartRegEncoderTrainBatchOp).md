# CART决策树回归编码器训练 (CartRegEncoderTrainBatchOp)
Java 类名：com.alibaba.alink.operator.batch.feature.CartRegEncoderTrainBatchOp

Python 类名：CartRegEncoderTrainBatchOp


## 功能介绍
使用CART回归模型，将输入数据编码为特征。
