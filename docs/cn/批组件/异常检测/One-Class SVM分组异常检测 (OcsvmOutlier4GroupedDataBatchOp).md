# One-Class SVM分组异常检测 (OcsvmOutlier4GroupedDataBatchOp)
Java 类名：com.alibaba.alink.operator.batch.outlier.OcsvmOutlier4GroupedDataBatchOp

Python 类名：OcsvmOutlier4GroupedDataBatchOp
