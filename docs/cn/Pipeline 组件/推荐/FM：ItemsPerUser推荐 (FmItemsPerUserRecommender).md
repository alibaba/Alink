# FM：ItemsPerUser推荐 (FmItemsPerUserRecommender)
Java 类名：com.alibaba.alink.pipeline.recommendation.FmItemsPerUserRecommender

Python 类名：FmItemsPerUserRecommender
