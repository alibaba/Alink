# 转MTable (ToMTableStreamOp)
Java 类名：com.alibaba.alink.operator.stream.dataproc.ToMTableStreamOp

Python 类名：ToMTableStreamOp
...
public class ToVectorDemoTest extends AlinkTestBase {
	...
	public void test() throws Exception {
		...
		new ToMTableStreamOp().setSelectedCol("vec").linkFrom(data).print();
        StreamOperator.execute();
	}
}
```
