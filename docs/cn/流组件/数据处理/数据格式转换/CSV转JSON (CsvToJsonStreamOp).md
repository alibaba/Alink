# CSV转JSON (CsvToJsonStreamOp)
Java 类名：com.alibaba.alink.operator.stream.dataproc.format.CsvToJsonStreamOp

Python 类名：CsvToJsonStreamOp
...
import com.alibaba.alink.operator.stream.dataproc.format.CsvToJsonStreamOp;
...
public class CsvToJsonStreamOpTest {
	@Test
	public void testCsvToJsonStreamOp() throws Exception {
		...
		StreamOperator <?> op = new CsvToJsonStreamOp()
			.setCsvCol("csv")
			.setSchemaStr("f0 double, f1 double")
			.setReservedCols("row")
			.setJsonCol("json")
