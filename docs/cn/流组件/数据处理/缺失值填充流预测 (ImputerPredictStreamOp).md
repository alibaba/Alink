# 缺失值填充流预测 (ImputerPredictStreamOp)
...
填充数据中的缺失值，读取ImputerTrainBatchOp训练的模型数据。
...
public class ImputerPredictStreamOpTest {
	@Test
	public void testImputerPredictStreamOp() throws Exception {
