# 随机森林回归预测 (RandomForestRegPredictStreamOp)
Java 类名：com.alibaba.alink.operator.stream.regression.RandomForestRegPredictStreamOp

Python 类名：RandomForestRegPredictStreamOp
...
public class RandomForestRegPredictStreamOpTest {
	@Test
	public void testRandomForestRegPredictStreamOp() throws Exception {
