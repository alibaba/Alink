# 分位数离散化预测 (QuantileDiscretizerPredictStreamOp)
...
public class QuantileDiscretizerPredictStreamOpTest {
	@Test
	public void testQuantileDiscretizerPredictStreamOp() throws Exception {
