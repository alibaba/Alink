# C45决策树分类预测 (C45PredictStreamOp)
Java 类名：com.alibaba.alink.operator.stream.classification.C45PredictStreamOp

Python 类名：C45PredictStreamOp
...
public class C45PredictStreamOpTest {
	@Test
	public void testC45PredictStreamOp() throws Exception {
