# CART决策树分类预测 (CartPredictStreamOp)
Java 类名：com.alibaba.alink.operator.stream.classification.CartPredictStreamOp

Python 类名：CartPredictStreamOp
...
public class CartPredictStreamOpTest {
	@Test
	public void testCartPredictStreamOp() throws Exception {
