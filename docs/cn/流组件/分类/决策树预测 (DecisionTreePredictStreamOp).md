# 决策树预测 (DecisionTreePredictStreamOp)
Java 类名：com.alibaba.alink.operator.stream.classification.DecisionTreePredictStreamOp

Python 类名：DecisionTreePredictStreamOp
...
public class DecisionTreePredictStreamOpTest {
	@Test
	public void testDecisionTreePredictStreamOp() throws Exception {
