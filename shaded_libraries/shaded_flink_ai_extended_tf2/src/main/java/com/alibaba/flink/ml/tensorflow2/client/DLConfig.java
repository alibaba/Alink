...
public class DLConfig implements Serializable {
	 ...
	 */
	public DLConfig(int workerNum, int psNum, Map<String, String> properties, String pythonFile,
	...
	/**
	 * Construct a DLConfig
	 *
	 * @param workerNum the number of workers
	 * @param psNum the number of PS
	 * @param properties properties
	 * @param pythonFiles the python files, the first one will be the entry python file
	 * @param funName the entry function name in the first python file
	 */
	public DLConfig(int workerNum, int psNum, Map<String, String> properties, String[] pythonFiles,
					String funName, String envPath) {
	...
	public DLConfig deepCopy() {
		...
		DLConfig config = new DLConfig(getWorkerNum(), getPsNum(), destProperties, pyFiles,
	...
	private void loadSystemConfig() {
		System.err.println("loadSystemConfig in DLConfig not supported.");
