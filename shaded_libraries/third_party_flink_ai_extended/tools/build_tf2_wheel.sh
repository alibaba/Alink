...
tensorflow2Path=${basePath}/../flink-ml-tensorflow2/python/
cd ${tensorflow2Path}
python setup.py bdist_wheel
cp ${tensorflow2Path}/dist/* ${distPath}/
rm -rf ${tensorflow2Path}/build/ ${tensorflow2Path}/dist/ ${tensorflow2Path}/flink_ml_tensorflow2.egg-info
