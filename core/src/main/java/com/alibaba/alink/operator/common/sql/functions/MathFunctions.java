...
public class MathFunctions {
    ...
    public static Method LOG_WITH_BASE_DOU_DEC = Types.lookupMethod(MathFunctions.class, "log", double.class, BigDecimal.class);
    public static Method LOG_WITH_BASE_DEC_DOU = Types.lookupMethod(MathFunctions.class, "log", BigDecimal.class, double.class);
    public static Method LOG_WITH_BASE_DEC_DEC = Types.lookupMethod(MathFunctions.class, "log", BigDecimal.class, BigDecimal.class);
