...
public class StringMeasureIterator implements BaseMeasureIterator <String, StringMeasureIterator> {
	...
	@Override
	public void merge(StringMeasureIterator iterator) {
	...
	@Override
	public StringMeasureIterator clone() {
		StringMeasureIterator iterator = new StringMeasureIterator();
	...
	public void finalResult(SummaryResultCol src) {
		src.init(String.class, count + countMissing, count, countMissing, 0, 0, 0, 0,
