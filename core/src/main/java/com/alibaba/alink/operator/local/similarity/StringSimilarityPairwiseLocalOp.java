...
@NameCn("字符串两两相似度计算")
public class StringSimilarityPairwiseLocalOp extends MapLocalOp <StringSimilarityPairwiseLocalOp>
	implements StringTextPairwiseParams <StringSimilarityPairwiseLocalOp> {

	/**
	 * default constructor.
	 */
	public StringSimilarityPairwiseLocalOp() {
		this(null);
	}

	public StringSimilarityPairwiseLocalOp(Params params) {
