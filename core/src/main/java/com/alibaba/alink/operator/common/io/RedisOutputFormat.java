...
public class RedisOutputFormat extends RichOutputFormat <Row> {
	...
	public void open(int taskNumber, int numTasks) throws IOException {
		...
		String[] keyColNames = params.get(RedisSinkParams.KEY_COLS);
		String[] valueColNames = params.get(RedisSinkParams.VALUE_COLS);
