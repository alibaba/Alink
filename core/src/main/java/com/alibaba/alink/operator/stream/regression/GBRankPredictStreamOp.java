 ...
 */
public class GBRankPredictStreamOp extends ModelMapStreamOp <GBRankPredictStreamOp>
	implements GbdtRegPredictParams <GBRankPredictStreamOp> {
	private static final long serialVersionUID = -8043058039210125643L;

	public GBRankPredictStreamOp(BatchOperator model) {
		this(model, null);
	}

	public GBRankPredictStreamOp(BatchOperator model, Params params) {
