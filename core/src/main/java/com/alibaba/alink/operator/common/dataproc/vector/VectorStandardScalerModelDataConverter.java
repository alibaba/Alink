...
public class VectorStandardScalerModelDataConverter extends
	RichModelDataConverter <Tuple3 <Boolean, Boolean, BaseVectorSummary>, Tuple4 <Boolean, Boolean, double[],
		double[]>> {
	...
	public Tuple3 <Params, Iterable <String>, Iterable <Row>> serializeModel(
		Tuple3 <Boolean, Boolean, BaseVectorSummary> modelData) {
	 ...
	 */
	@Override
	public Tuple4 <Boolean, Boolean, double[], double[]> deserializeModel(Params meta, Iterable <String> data,
