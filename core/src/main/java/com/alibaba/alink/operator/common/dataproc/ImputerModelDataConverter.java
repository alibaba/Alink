...
import static com.alibaba.alink.params.dataproc.ImputerTrainParams.FILL_VALUE;
import static com.alibaba.alink.params.dataproc.ImputerTrainParams.SELECTED_COLS;
import static com.alibaba.alink.params.dataproc.ImputerTrainParams.STRATEGY;
import static com.alibaba.alink.params.dataproc.ImputerTrainParams.Strategy;

/**
 * This converter can help serialize and deserialize the model data.
 */
public class ImputerModelDataConverter
	extends RichModelDataConverter <Tuple3 <Strategy, TableSummary, String>, Tuple3 <Strategy, double[], String>> {
	...
	public Tuple3 <Params, Iterable <String>, Iterable <Row>> serializeModel(
		Tuple3 <Strategy, TableSummary, String> modelData) {
	 ...
	 */
	@Override
	public Tuple3 <Strategy, double[], String> deserializeModel(Params meta, Iterable <String> data,
