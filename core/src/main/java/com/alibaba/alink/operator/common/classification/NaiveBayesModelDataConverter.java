...
public class NaiveBayesModelDataConverter
     ...
     */
    @Override
    protected NaiveBayesModelData deserializeModel(Params meta, Iterable<String> stringData, Iterable<Object> distinctLabels) {
    ...
    private static class NaiveBayesProbInfo {
        public Number[][][] theta;
        public double[] pi;
    }
