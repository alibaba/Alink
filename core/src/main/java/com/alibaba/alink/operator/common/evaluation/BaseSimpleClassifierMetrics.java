...
public abstract class BaseSimpleClassifierMetrics<T extends BaseSimpleClassifierMetrics <T>> extends BaseMetrics <T> {
	...
	static final ParamInfo <Double> LOG_LOSS = ParamInfoFactory
		.createParamInfo("LogLoss", Double.class)
		.setDescription("logloss, -sum(y_i*log(p_i) + (1-y_i)*log(1-p_i))")
		.setHasDefaultValue(null)
		.build();

	static final ParamInfo <Long> TOTAL_SAMPLES = ParamInfoFactory
		.createParamInfo("TotalSamples", Long.class)
		.setDescription("total samples")
		.setRequired()
		.build();

	static final ParamInfo <long[]> ACTUAL_LABEL_FREQUENCY = ParamInfoFactory
		.createParamInfo("ActualLabelFrequency", long[].class)
		.setDescription("actual label frequency")
		.setRequired()
		.build();

	static final ParamInfo <double[]> ACTUAL_LABEL_PROPORTION = ParamInfoFactory
	...
	static final ParamInfo <Double> MACRO_ACCURACY = ParamInfoFactory
		.createParamInfo("MacroAccuracy", Double.class)
		.setDescription("macro accuracy")
		.setRequired()
		.build();

	static final ParamInfo <Double> MICRO_ACCURACY = ParamInfoFactory
		.createParamInfo("MicroAccuracy", Double.class)
		.setDescription("micro accuracy")
		.setRequired()
		.build();

	static final ParamInfo <Double> WEIGHTED_ACCURACY = ParamInfoFactory
	...
	static final ParamInfo <Double> MACRO_KAPPA = ParamInfoFactory
		.createParamInfo("MacroKappa", Double.class)
		.setDescription("macro kappa")
		.setRequired()
		.build();

	static final ParamInfo <Double> MICRO_KAPPA = ParamInfoFactory
		.createParamInfo("MicroKappa", Double.class)
		.setDescription("micro kappa")
		.setRequired()
		.build();

	static final ParamInfo <Double> WEIGHTED_KAPPA = ParamInfoFactory
		.createParamInfo("WeightedKappa", Double.class)
		.setDescription("weighted kappa")
		.setRequired()
		.build();

	static final ParamInfo <Double> MACRO_PRECISION = ParamInfoFactory
	...
	static final ParamInfo <Double> MACRO_RECALL = ParamInfoFactory
	...
	static final ParamInfo <Double> MACRO_F1 = ParamInfoFactory
	...
	static final ParamInfo <double[]> SPECIFICITY_ARRAY = ParamInfoFactory
		.createParamInfo("SpecificityArray", double[].class)
		.setDescription("Specificity list, Specificity = TNR")
		.setRequired()
		.build();

	static final ParamInfo <double[]> SENSITIVITY_ARRAY = ParamInfoFactory
	...
	static final ParamInfo <double[]> ACCURACY_ARRAY = ParamInfoFactory
		.createParamInfo("AccuracyArray", double[].class)
		.setDescription("accuracy list, ACCURACY: (TP + TN) / Total")
		.setRequired()
		.build();

	static final ParamInfo <double[]> KAPPA_ARRAY = ParamInfoFactory
	...
	public Long getTotalSamples() {
		return get(TOTAL_SAMPLES);
	}

	public long[] getActualLabelFrequency() {
		return get(ACTUAL_LABEL_FREQUENCY);
	}

	public double[] getActualLabelProportion() {
		return get(ACTUAL_LABEL_PROPORTION);
	}
