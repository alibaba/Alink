...
import static com.alibaba.alink.operator.common.tree.parallelcart.communication.ReduceScatter.TRANSFER_BUFFER_SIZE;
...
public final class FakeDoublePrimitiveArraySerializer extends TypeSerializerSingleton <double[]> {
	...
	public final double[] buffer = new double[TRANSFER_BUFFER_SIZE];
