 ...
 * <p>
 * The different between {@link EstimatorBase} and {@link TrainerLegacy} is that
 ...
 *
 * @param <T> The class type of the {@link TrainerLegacy} implementation itself
 * @param <M> class type of the {@link ModelBase} this Trainer produces.
 */
public abstract class TrainerLegacy<T extends TrainerLegacy <T, M>, M extends MapModel <M>>
