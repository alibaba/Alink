...
public interface DeepARTrainParams<T> extends
	HasTimeCol <T>,
	...
	HasNumEpochsDefaultAs10 <T>,
	HasBatchSizeDefaultAs128 <T>,
	HasCheckpointFilePath <T>,
	HasPythonEnv <T>,
	HasIntraOpParallelism <T>,
	HasNumWorkersDefaultAsNull <T>,
	HasNumPssDefaultAsNull <T> {
}
