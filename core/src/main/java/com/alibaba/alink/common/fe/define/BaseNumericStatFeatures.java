...
import com.alibaba.alink.common.fe.define.window.SlotWindowNumericStatFeatures;
...
public abstract class BaseNumericStatFeatures<T extends BaseStatFeatures <T>> extends BaseStatFeatures <T> implements
	Serializable {
