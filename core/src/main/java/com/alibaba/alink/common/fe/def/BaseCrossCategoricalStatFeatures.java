...
import com.alibaba.alink.common.fe.def.window.SlotWindowCrossCategoricalStatFeatures;
import com.alibaba.alink.common.fe.def.window.TumbleWindowCrossCategoricalStatFeatures;

import java.util.ArrayList;
import java.util.List;

public abstract class BaseCrossCategoricalStatFeatures<T extends BaseStatFeatures <T>> extends BaseStatFeatures <T> {
