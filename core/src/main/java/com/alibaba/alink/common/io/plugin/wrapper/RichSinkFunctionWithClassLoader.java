...
public class RichSinkFunctionWithClassLoader extends RichSinkFunction <Row>
	...
	public RichSinkFunctionWithClassLoader(ClassLoaderFactory factory, RichSinkFunction <Row> internal) {
	...
	public void notifyCheckpointComplete(long checkpointId) throws Exception {
		if (internal instanceof CheckpointListener) {
			factory.doAsThrowRuntime(
				() -> ((CheckpointListener) getRichSinkFunction()).notifyCheckpointComplete(checkpointId));
		} else {
