...
@Internal
public class PyDateScalarFn extends BasePyScalarFn <Integer, PyScalarFnHandle <Integer>> {

	public PyDateScalarFn(String name, String fnSpecJson) {
		this(name, fnSpecJson, Collections.emptyMap());
	}

	public PyDateScalarFn(String name, String fnSpecJson, Map <String, String> runConfig) {
