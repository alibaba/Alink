...
from akdl.engine.inputs import parse_feature_specs, get_dataset_fn, get_feature_placeholders
...
def main(task_config: StreamTaskConfig):
    task_config = StreamTaskConfig(**task_config.__dict__,
                                   dataset_fn=lambda: task_config.tf_context.flink_stream_dataset(),
