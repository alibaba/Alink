...
public class ClusterEvaluationUtilTest {
    ...
    public void getClusterStatisticsCosineTest() {
        ...
        Tuple3<String, DenseVector, DenseVector> meanAndSum = ClusterEvaluationUtil.calMeanAndSum(Arrays.asList(rows0), 3, new CosineDistance());
    ...
    public void calSilhouetteCoefficientTest(){
		...
		Tuple3<String, DenseVector, DenseVector> meanAndSum1 = ClusterEvaluationUtil.calMeanAndSum(Arrays.asList(rows0), 3, new EuclideanDistance());
		...
		Tuple3<String, DenseVector, DenseVector> meanAndSum2 = ClusterEvaluationUtil.calMeanAndSum(Arrays.asList(rows1), 3, new EuclideanDistance());
        ...
        Assert.assertEquals((double)ClusterEvaluationUtil.calSilhouetteCoefficient(rows1[1], clusterMetricsSummary1).f0, 1.0, 0.01);
    }
