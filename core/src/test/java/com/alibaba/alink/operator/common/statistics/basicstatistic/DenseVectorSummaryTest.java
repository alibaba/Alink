...
public class DenseVectorSummaryTest {
	...
	public void test() {
		...
		Assert.assertArrayEquals(new double[] {1.5811, 1.5811, 0.0}, ((DenseVector) srt.standardDeviation()).getData(),
			10e-4);
		Assert.assertArrayEquals(new double[] {15, 15, 15}, ((DenseVector) srt.normL1()).getData(), 10e-4);
		Assert.assertArrayEquals(new double[] {7.416198, 7.416198, 6.7082}, ((DenseVector) srt.normL2()).getData(),
			10e-4);
	}
