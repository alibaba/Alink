...
public class HugeMultiStringIndexerPredictBatchOpTest extends AlinkTestBase {
	@Test
	public void testHugeMultiStringIndexerPredict() throws Exception {
		...
		BatchOperator <?> predictor = new HugeMultiStringIndexerPredictBatchOp().setSelectedCols("f0", "f1").setOutputCols(
