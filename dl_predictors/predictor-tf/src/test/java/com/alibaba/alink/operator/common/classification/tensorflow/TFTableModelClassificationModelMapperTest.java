...
public class TFTableModelClassificationModelMapperTest {
	...
	public void test() throws Exception {
		...
		TFTableModelClassificationModelMapper mapper = new TFTableModelClassificationModelMapper(modelOp.getSchema(),
