...
import com.alibaba.alink.operator.common.io.kafka.KafkaSourceBuilder;
 ...
 */
@IoOpAnnotation(name = "kafka", hasTimestamp = true, ioType = IOType.SourceStream)
public final class KafkaSourceStreamOp extends BaseKafkaSourceStreamOp<KafkaSourceStreamOp>
