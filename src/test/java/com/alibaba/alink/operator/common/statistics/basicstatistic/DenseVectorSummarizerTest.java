...
public class DenseVectorSummarizerTest {
    ...
    public void visitSparseVector() {
        ...
        assertArrayEquals(new double[]{0, -5.0, 0, 0, 0.0}, ((SparseVector) addSparseSummary.min()).toDenseVector().getData(), 10e-6);
        assertArrayEquals(new double[]{5.0, 0, 3.0, 1.0, 0.0}, ((SparseVector) addSparseSummary.max()).toDenseVector().getData(), 10e-6);
